...
export class TallyHSN{
    ...
    hsnSacTable(){
      ...
      html +=`
        ...
        <td class="font-10 padding-5555" colspan="2"
          style="text-transform:uppercase;color:#000;text-align: center;font-weight: normal;padding: 2px;border-top:0;border-bottom:0;border-right:0;">
        ...
        html +=`<td class="font-12 padding-5555" rowspan="2"
          style="text-transform:uppercase;color:#000;text-align: center;padding: 2px;border-right:0;border-top:0;border-right:0;border-right: 0;">
          Total Tax</td>
        </tr>
        <tr>
    ...
    hsnSacRow(hsnCode,hsnData){
      ...
      for (let i = 0; i < hsnData.length; i++) {
        ...
        html +=`
          <tr>
          <td class="padding-5555 font-12" style="color:#000;border-bottom: 0;border-right:0;border-top: 0;padding: 2px;text-align: center;">
            ${(hsnCode !='noHsn')?hsnCode:''}</td>
          <td class="padding-5555 font-12"
            style="color:#000;border-bottom: 0;border-right:0;border-top: 0;padding: 2px;text-align: center !important;">
            ${commonTempData.unitAdjuster(element?.taxableValue || 0)}</td>
          <td class="padding-5555 font-12" style="color:#000;border-bottom: 0;border-right:0;border-top: 0;padding: 2px;text-align: left;">
          ${(!this.sameState&&this.isTax)?(+element?.taxPercentage)?.toFixed(2):(+element?.taxPercentage/2)?.toFixed(2)}%
          </td>
          <td class="padding-5555 font-12" style="color:#000;border-bottom: 0;border-right:0;border-top: 0;padding: 2px;text-align: right;">
          ${(!this.sameState&&this.isTax)?(element?.taxAmount)?.toFixed(2):(element?.taxAmount/2)?.toFixed(2)}</td>
          `
          if(this.sameState&&this.isTax){
            html+=`<td class="padding-5555 font-12" style="color:#000;border-bottom: 0;border-right:0;border-top: 0;padding: 2px;text-align: left;">
          ...
          html+=`<td class="padding-5555 font-12"
            style="color:#000;border-bottom: 0;border-right:0;border-top: 0;padding: 2px;text-align: right;border-right: 0;">
    ...
    templateBody(){
      ...
      style="background-color:#dbdaf3;border-bottom: 1px solid #4f4f4f;-webkit-print-color-adjust: exact !important;color-adjust: exact !important;">
      ...
      style="border-bottom: 1px solid #4f4f4f;-webkit-print-color-adjust: exact !important;color-adjust: exact !important;">
      ...
      ${this.commonTemplatebody({...bodyObj,amount:this.data?.flatDiscount,title:'Invoice Discount'})}
        ...
        <th class="f-14 padding-5555" style="font-size:14px;color:#4f4f4f;text-align: right;padding:2px;border-right:0;border-bottom:0;text-transform: uppercase;border-left: 0px;"></th>
        ...
        <th class="f-14 padding-5555" style="font-weight:bold;border-right:0;border-bottom:0;font-size:14px;color:#4f4f4f;text-align: right;padding:2px;text-transform: uppercase;">
    ...
    commonTemplatebody(data){
      ...
      <th class="f-14 padding-5555" style="font-weight:normal;border-right:0;border-bottom:0;font-size:14px;color:#4f4f4f;text-align: right;padding:2px;text-transform: uppercase;${dynamicBoldCss}">
